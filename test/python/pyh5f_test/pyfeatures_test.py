...
class FeaturesTests(TestCase):
    ...
    def test_in_equality(self):
        ...
        b = Item("b", np.ones((1000000, 4) ,dtype=np.float64), begin, end, properties, True)
        c = Item("c", np.zeros((1000000, 4) ,dtype=np.float64), begin, end, properties, True)
    ...
    def test_copy_true(self):
        ...
        name = "Test"
        properties = {}
        features = Item(name, feats, begin, end, properties, True)
