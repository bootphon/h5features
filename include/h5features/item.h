...
/**
   ...
   - optional properties (`h5features::properties`) attached to the features,
...
public:
   ...
   */
  item(const std::string &name, const h5features::features &features, const h5features::times &times,
       const h5features::properties &properties = {}, bool check = true);

  item(const std::string &name, h5features::features &&features, h5features::times &&times,
       h5features::properties &&properties, bool check = true);
  /// @}
