...
public:
  ...
  h5features::item read_item(const std::string &name, bool ignore_properties) const override;

  h5features::item read_item(const std::string &name, double start, double stop, bool ignore_properties) const override;
