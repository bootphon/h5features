...
public:
  ...
  /**
     ...
     dimension and each timestamp is interpreted as the center time of its
  ...
  /**
     \brief Constructs a `times` instance from start and stop timestamps
  ...
  */
  ...
  /**
     ...
     - when `times::format::interval`, we have \f$(t_\text{start})_i \leq (t_\text{stop})_i\f$ for
       each frame \f$i\f$
