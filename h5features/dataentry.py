...
class DataEntry(object):
    """The DataEntry class is the base class of h5features.Data entries.
    ...
    """
    def __init__(self, data, dim, dtype, check=True):
        if check:
    ...
    def create_dataset(self, name, group, chunk_size):
        ...
        group.create_dataset(name, shape, dtype=self.dtype,
