...
# -*- coding: utf-8 -*-
#
# h5features.rst documentation build configuration file, created by
...
htmlhelp_basename = 'h5featuresrstdoc'
...
texinfo_documents = [
  (master_doc, 'h5featuresrst', 'h5features.rst Documentation',
   author, 'h5featuresrst', 'One line description of project.',
   'Miscellaneous'),
]
