...
bool h5features::item::operator==(const item& other) const noexcept
{
   ...
   else
   {
      return m_name == other.m_name
         and m_features == other.m_features
         and m_times == other.m_times
         and m_properties == other.m_properties;
   }
}
...
std::size_t h5features::item::dim() const
{
   return m_features.dim();
}


std::size_t h5features::item::size() const noexcept
{
   return m_features.size();
}


std::string h5features::item::name() const noexcept
{
   return m_name;
}


bool h5features::item::has_properties() const noexcept
{
   return m_properties.size() != 0;
}


const h5features::times& h5features::item::times() const noexcept
{
   return m_times;
}


const h5features::features& h5features::item::features() const noexcept
{
   return m_features;
}


const h5features::properties& h5features::item::properties() const noexcept
{
   return m_properties;
}
