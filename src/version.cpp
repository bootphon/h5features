...
static const std::unordered_map<h5features::version, std::string> version_map{{h5features::version::v1_0, "1.0"},
...
h5features::version h5features::read_version(const hdf5::Group &group) {
  static const std::unordered_map<std::string, h5features::version> map{{"1.0", h5features::version::v1_0},
